                    ...
                    >
                      {formLogo ? (
                        ...
                        <div className="flex flex-col items-center gap-1">
                          ...
                          <span className="text-[8px] font-bold text-slate-500 group-hover:text-primary">UPLOAD</span>
                        </div>
                      )}
              ...
              <div className="sticky top-32">
                <div className="bg-surface-container-high rounded-[3rem] p-10 shadow-[0_40px_80px_rgba(0,0,0,0.15)] overflow-hidden border-none transition-all duration-500">
                  ...
                  <div className="relative mx-auto w-full max-w-[300px] aspect-[9/19] bg-surface-container-lowest rounded-[3.5rem] shadow-2xl overflow-hidden transition-all duration-500">
                    ...
                    <div className="h-full flex flex-col bg-[#091421] text-left relative">
                      
                      {/* Mobile Header (Real Equivalent) */}
                      <div className="px-5 pb-4 pt-10 flex justify-between items-center bg-[#091421]/90 backdrop-blur-md border-b border-outline-variant z-40 shrink-0">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            <span className="text-lg font-black text-white transition-all font-headline tracking-tight leading-tight">{formName || 'Orderin'}</span>
                            <span className="text-[9px] text-slate-400 font-label uppercase tracking-widest mt-0.5">Meja 1 (Lantai 1)</span>
                          </div>
                        </div>
                        <div className="w-8 h-8 rounded-full bg-surface-container-highest border border-outline-variant flex items-center justify-center">
                          <span className="material-symbols-outlined text-sm text-slate-400 transition-colors" style={{ color: activeTheme.primary }}>person_outline</span>
                        </div>
                      </div>
                      ...
                      <div className="flex-grow overflow-y-auto [&::-webkit-scrollbar]:hidden px-4 pt-4 pb-8 z-10">
                        ...
                        <div className="mb-4">
                           ...
                           <p className="text-slate-400 text-[10px] font-medium leading-tight">Pilih hidangan favorit dari katalog kami hari ini.</p>
                        </div>
  
                        {/* Search Bar Mock */}
                        <div className="relative flex items-center mb-4">
                          <span className="material-symbols-outlined absolute left-4 text-sm text-slate-500">search</span>
                          <input 
                            disabled
                        ...
                        <div className="flex gap-2 mb-4 overflow-hidden">
                           ...
                           <span className="px-3 py-1.5 rounded-lg text-[9px] font-bold bg-surface-container text-slate-400 border border-outline-variant shrink-0">Coffee</span>
                           <span className="px-3 py-1.5 rounded-lg text-[9px] font-bold bg-surface-container text-slate-400 border border-outline-variant shrink-0">Pastry</span>
                        </div>
                          ...
                          {previewMenus.slice(0, 2).map((item, idx) => (
                            <div key={item.id || idx} className="flex flex-col bg-surface-container rounded-2xl overflow-hidden border border-outline-variant hover:translate-y-[-2px] transition-all">
                              ...
                              <div className="p-3 flex flex-col">
                                <h3 className="text-xs font-bold text-white mb-1 font-headline truncate">{item.nama}</h3>
                  ...
                  <p className="text-center text-[10px] text-slate-400 mt-6 uppercase tracking-[0.2em] font-black">Pratinjau Order Menu</p>
                </div>
              </div>
            </div>
      </div>
