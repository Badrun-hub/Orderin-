...
export default function Cart() {
  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen pb-32">
      {/* TopAppBar */}
      <header className="bg-[#091421]/80 backdrop-blur-md sticky top-0 w-full z-50 px-6 py-4 flex items-center justify-between">
        <button 
          onClick={() => navigate(-1)}
          className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/5 transition-colors text-slate-400"
        >
          <span className="material-symbols-outlined">arrow_back</span>
        </button>
        <h1 className="text-xl font-bold font-headline tracking-tight text-white">Pesanan Anda</h1>
              ...
              <div className="flex-grow flex flex-col justify-center">
                ...
                <div className="flex items-center gap-4 bg-surface-container-highest rounded-xl w-fit py-1 px-2">
                  <button 
                    ...
                    className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-white hover:bg-surface-container-lowest rounded-lg transition-colors font-black"
                  >
                  ...
                  <button 
                    ...
                    className="w-8 h-8 flex items-center justify-center text-slate-400 hover:text-secondary hover:bg-secondary/10 rounded-lg transition-colors font-black"
                  >
        ...
        <section>
          <div className="relative">
            ...
            <textarea 
              ...
              className="w-full bg-surface-container-highest border border-outline-variant rounded-[1.5rem] p-4 pl-12 text-sm text-on-surface placeholder:text-slate-500 focus:ring-2 focus:ring-primary/50 outline-none min-h-[100px] resize-none transition-all duration-300 focus:bg-surface-container-low"
