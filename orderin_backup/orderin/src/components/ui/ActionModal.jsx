...
export default function ActionModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-on-surface/50 backdrop-blur-sm flex items-center justify-center p-4 animate-[fadeIn_0.2s_ease-out]">
      <div className="bg-surface-container-high w-full max-w-sm rounded-[2rem] p-6 ghost-border shadow-2xl text-center">
        ...
        <div className="flex gap-3 mt-auto">
          {type !== 'alert' && (
             <button onClick={onCancel} className="flex-1 py-3 bg-surface-container-highest text-sm font-bold uppercase rounded-xl hover:bg-on-surface/10 transition-colors">{cancelText}</button>
          )}
