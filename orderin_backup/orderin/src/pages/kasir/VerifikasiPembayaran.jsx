...
export default function VerifikasiPembayaran() {
  ...
  return (
    <div className="bg-surface text-on-surface font-body min-h-screen pb-32">
      {/* TopAppBar */}
      <header className="fixed top-0 w-full z-40 bg-surface-container-low/80 backdrop-blur-md flex justify-between items-center px-6 py-4 border-b border-outline-variant">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-on-surface-variant font-label uppercase tracking-widest">Meja {data.tableId} • {data.customerName}</p>
          </div>
        </div>
      </header>
      ...
      <main className="pt-24 px-6 max-w-xl mx-auto space-y-6">
        ...
        <div className="bg-surface-container-low rounded-[2rem] p-6 ghost-border text-center">
          ...
          <div className="inline-flex bg-surface-container-highest px-3 py-1.5 rounded-lg text-xs font-bold font-headline uppercase tracking-wider text-on-surface-variant">
            {data.paymentMethod}
          </div>
        </div>
        ...
        <div>
          ...
          <div className="w-full h-[400px] bg-surface-container rounded-[2rem] overflow-hidden ghost-border relative">
            ...
            <div className="absolute bottom-4 right-4 bg-on-surface/50 backdrop-blur-md p-2 rounded-full text-on-surface pointer-events-none">
      ...
      {showRejectModal && (
        <div className="fixed inset-0 z-50 bg-on-surface/50 backdrop-blur-sm flex items-center justify-center p-6">
