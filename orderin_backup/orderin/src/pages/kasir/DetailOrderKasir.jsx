...
export default function DetailOrderKasir() {
  ...
  const statusColorMap = {
    ...
    selesai: { bg: 'bg-surface-container-highest/50 text-on-surface-variant', label: 'Selesai', ring: 'ring-slate-500/30' },
      ...
      <header className="fixed top-0 w-full z-40 bg-surface-container-low/80 backdrop-blur-md flex justify-between items-center px-6 py-4 border-b border-outline-variant">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-on-surface-variant font-label uppercase tracking-widest">{order.customerName}</p>
          </div>
        </div>
