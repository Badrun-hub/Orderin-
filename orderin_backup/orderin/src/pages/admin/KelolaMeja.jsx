  ...
  return (
    <>
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-surface-container p-8 rounded-[3rem] shadow-xl shadow-surface-container-lowest/5 flex-wrap gap-6 transition-all duration-300">
          <div>
          ...
          <div className="bg-surface-container-low w-full max-w-sm rounded-[2rem] p-6 ghost-border">
             ...
             <form onSubmit={handleSave} className="space-y-4">
               ...
               <div className="flex gap-3 mt-8">
                 <button type="button" onClick={() => setShowModal(false)} className="flex-1 py-3 bg-surface-container-highest text-sm font-bold uppercase rounded-xl hover:bg-on-surface/10 transition-colors">Batal</button>
      ...
      {qrModal && (
        <div className="fixed inset-0 z-50 bg-on-surface/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-on-surface text-surface text-black w-full max-w-sm rounded-[2rem] p-8 flex flex-col items-center text-center shadow-2xl relative overflow-hidden">
             ...
             <div className="w-full flex flex-col items-center">
               ...
               <div className="w-56 h-56 bg-surface-container-highest rounded-2xl p-2 mb-2 border-4 border-black/5">
               ...
               <div className="mb-6 px-4 py-2 bg-slate-50 rounded-xl border border-slate-100 w-full">
                 <p className="text-[10px] text-on-surface-variant font-mono break-all leading-tight">
               ...
               <p className="text-xs uppercase tracking-widest font-bold text-on-surface-variant mb-8 border-b-2 border-slate-200 pb-4 w-full">Scan untuk memesan</p>
             </div>
             
             <div className="w-full flex flex-col sm:flex-row gap-3">
               <button onClick={() => setQrModal(null)} className="flex-1 py-3 bg-surface-container-highest text-on-surface-variant text-xs font-bold uppercase rounded-xl hover:bg-surface-container-highest transition-colors">Tutup</button>
