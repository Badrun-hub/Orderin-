...
export default function QRLanding() {
  ...
  return (
    <div className="flex-grow flex flex-col items-center justify-center relative px-6 pt-20 pb-12 overflow-hidden min-h-screen border-none bg-surface text-on-surface">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-surface-container-low/80 backdrop-blur-md flex justify-between items-center px-6 py-4">
        ...
        <button className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-on-surface/10 transition-colors text-on-surface-variant">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full h-14 bg-surface-container-highest rounded-xl pl-12 pr-4 text-on-surface border-none focus:ring-2 focus:ring-surface-tint transition-all placeholder:text-on-surface-variant" 
